...
# considering phase mismatch between a range of input wavelengths where 1560 nm is the LONG wavelength side
...
# considering phase mismatch between a range of input wavelengths where 1560 nm is the SHORT wavelength side
